...
bitcoin-cli -regtest -rpcwallet=btrustwallet createrawtransaction '''[{"txid":"'$utxo_txid'", "vout":'$vout_one', "sequence":1}, {"txid":"'$utxo_txid'", "vout":'$vout_two'}]''' '''{"'$reciever'":'$amount_btc'}'''